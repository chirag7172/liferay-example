...
import com.file.upload.model.EmployeeDetailClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"multiple-document-upload-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "multiple-document-upload-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.file.upload.model.impl.EmployeeDetailImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.file.upload.NoSuchEmployeeDetailException")) {
			return new com.file.upload.NoSuchEmployeeDetailException();
		}
